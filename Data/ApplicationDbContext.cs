...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser> 
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        #region Sedd StatusReservation
        List<StatusReservation> listSatatusReservation = new()
        {
        ...
        builder.Entity<StatusReservation>().HasData(listSatatusReservation);
        #endregion    

        #region  Seed Caterory
